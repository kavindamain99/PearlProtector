...
public class VolunteerHome extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button = (Button)findViewById(R.id.submitvolonteer );

        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(VolunteerHome.this, VolunteerSavedProjects.class);
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                MyAdapter adapter = new MyAdapter(VolunteerHome.this, R.layout.custom_project_details_volunteer, (ArrayList<Projects>) user);
    ...
    class MyAdapter extends ArrayAdapter<Projects> {
        ...
        public View getView(int position, View view, ViewGroup parent) {
            final SponserHome.ViewHolder holder;
            if (view == null) {
                holder = new SponserHome.ViewHolder();
                view = inflater.inflate(R.layout.custom_project_details_volunteer, null);
                ...
                holder.button1 = (Button) view.findViewById(R.id.volenteer);
                ...
                holder = (SponserHome.ViewHolder) view.getTag();
            }
            ...
            holder.button1.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(VolunteerHome.this, AddProjectVolunteerDetails.class);
            ...
            holder.button2.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(VolunteerHome.this, VolunteerAddInquoryDetails.class);
                    intent.putExtra("id", user.get(position).getId());
                    intent.putExtra("image", user.get(position).getImage());
                    intent.putExtra("title", user.get(position).getTitle());
                    intent.putExtra("venue", user.get(position).getVenue());

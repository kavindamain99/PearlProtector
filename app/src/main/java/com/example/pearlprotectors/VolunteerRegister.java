...
//                reference = rootNode.getReference("Users");
                ...
                if (!validateUserName() | !validateEmail() | !validateAge() | !validatePhone() | !validatePassword()) {
                    Toast.makeText(VolunteerRegister.this, "Sign up failed", Toast.LENGTH_SHORT).show();
                }
                else{

                    firebaseAuth.createUserWithEmailAndPassword(emaill, pass)
                            .addOnCompleteListener(VolunteerRegister.this, new OnCompleteListener<AuthResult>() {
                                @Override
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        Toast.makeText(VolunteerRegister.this, "Sign up successfully", Toast.LENGTH_SHORT).show();
                                        Intent intent = new Intent(VolunteerRegister.this, VolunteerHome.class);
                                        startActivity(intent);
                                    } else {
                                        Toast.makeText(VolunteerRegister.this, "Sign up failed", Toast.LENGTH_SHORT).show();

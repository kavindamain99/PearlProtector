...
public class VolunteerSavedProjects extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_volunteer_saved_projects);

        listView = (ListView)findViewById(R.id.listview);

        user = new ArrayList<>();

        ref = FirebaseDatabase.getInstance().getReference("VolunteerDetails");
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                MyAdapter adapter = new MyAdapter(VolunteerSavedProjects.this, R.layout.custom_volunteer_details, (ArrayList<SponsorshipDetails>) user);
    ...
    class MyAdapter extends ArrayAdapter<SponsorshipDetails> {
        ...
        public View getView(int position, View view, ViewGroup parent) {
            ...
            if (view == null) {
                ...
                view = inflater.inflate(R.layout.custom_volunteer_details, null);
            ...
            holder.button2.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    final AlertDialog alertDialog = new AlertDialog.Builder(getContext())
                            .setTitle("Do you want to delete this Volunteer details?")
                            .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialogInterface, int i) {

                                    final String idd = user.get(position).getId();
                                    FirebaseDatabase.getInstance().getReference("VolunteerDetails").child(idd).removeValue();
            ...
            holder.button1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    View view1 = inflater.inflate(R.layout.custom_update_volunteer_details, null);
                    ...
                    final String idd = user.get(position).getId();
                    final DatabaseReference reference = FirebaseDatabase.getInstance().getReference("VolunteerDetails").child(idd);
                    ...
                    buttonupdate.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            if (name.isEmpty()) {
                                ...
                                Toast.makeText(VolunteerSavedProjects.this, "Updated successfully", Toast.LENGTH_SHORT).show();

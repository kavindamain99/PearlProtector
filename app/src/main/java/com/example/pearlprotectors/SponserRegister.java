...
import com.example.pearlprotectors.Models.Users;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(SponserRegister.this, SponserLogin.class);
        ...
        reg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                reference = FirebaseDatabase.getInstance().getReference("Sponsers");
//                reference = rootNode.getReference("Users");
                ...
                if (!validateUserName() | !validateEmail() | !validateAge() | !validatePhone() | !validatePassword()) {
                    Toast.makeText(SponserRegister.this, "Sign up failed", Toast.LENGTH_SHORT).show();
                }
                else{

                    firebaseAuth.createUserWithEmailAndPassword(emaill, pass)
                            .addOnCompleteListener(SponserRegister.this, new OnCompleteListener<AuthResult>() {
                                @Override
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        Toast.makeText(SponserRegister.this, "Sign up successfully", Toast.LENGTH_SHORT).show();
                                        Intent intent = new Intent(SponserRegister.this, SponserHome.class);
                                        startActivity(intent);
                                    } else {
                                        Toast.makeText(SponserRegister.this, "Sign up failed", Toast.LENGTH_SHORT).show();

...
public class SponsorAddInquoryDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sponsor_add_inquory_details);
        ...
        ref = FirebaseDatabase.getInstance().getReference("SponsorshipsInquiryDetails");

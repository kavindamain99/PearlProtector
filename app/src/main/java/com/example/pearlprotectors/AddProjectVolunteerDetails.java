...
public class AddProjectVolunteerDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_project_volunteer_details);
        ...
        editText2 = (EditText)findViewById(R.id.type);

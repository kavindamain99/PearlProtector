...
public class SponserLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(SponserLogin.this, SponserRegister.class);
            ...
            public void onClick(View v) {
                ...
                if (emaill.isEmpty()) {
                    ...
                    firebaseAuth.signInWithEmailAndPassword(emaill, passwordd)
                            .addOnCompleteListener(SponserLogin.this, new OnCompleteListener<AuthResult>() {
                                @Override
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    if (task.isSuccessful()) {
                                        Toast.makeText(SponserLogin.this, "Successfully sign in", Toast.LENGTH_SHORT).show();
                                        Intent intent = new Intent(SponserLogin.this, SponserHome.class);
                                        startActivity(intent);
                                    }else {
                                        Toast.makeText(SponserLogin.this, "Sign in failed", Toast.LENGTH_SHORT).show();
                                    }
